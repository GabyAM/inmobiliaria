...
import { fetchTipoPropiedad, editTiposPropiedad } from '../api/tipoPropiedades';
...
export function EditTiposPropiedad (){
    ...
    const { 
        data: tipoPropiedad,
        isLoading,
        error } = useFetchData(fetchFn); //ealizar la solicitud HTTP utilizando la función fetchFn que definiste anteriormente y gestionar el estado de los datos obtenidos
